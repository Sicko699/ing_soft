...
from main import centrare_finestra, exit_button, go_back_office_button, go_front_office_button, go_gestione_magazzino, go_gestione_servizi, go_gestione_spa, go_home_button, multiplatform_open_read_data_json, multiplatform_open_write_data_json

abs_path = os.getcwd()

ASSETS_PATH = abs_path + "/assets/frame12"

class ModificaPrenotazioneSpa:
