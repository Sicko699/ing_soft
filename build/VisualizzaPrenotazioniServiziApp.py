...
from main import centrare_finestra, multiplatform_open_write_data_json,go_modifica_prenotazione_servizi, go_visualizza_prenotazioni_servizi, go_gestione_servizi, multiplatform_open_read_data_json, go_front_office_button, go_back_office_button, exit_button, go_home_button, go_gestione_magazzino, go_gestione_spa
...
class VisualizzaPrenotazioniServizi:
    ...
    def create_buttons(self):
        ...
        self.button_9 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi_modifica(0)),
            relief="flat"
        )
        self.button_9.place(
            x=690.0,
        ...
        self.button_10 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi_modifica(3)),
            relief="flat"
        )
        ...
        self.button_11 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi_modifica(2)),
            relief="flat"
        )
        ...
        self.button_12 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi_modifica(1)),
            relief="flat"
        )
        ...
        self.button_13 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi_modifica(4)),
            relief="flat"
        )
        ...
        self.button_14 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi_modifica(5)),
            relief="flat"
        )
        ...
        self.button_15 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi_modifica(7)),
            relief="flat"
        )
        ...
        self.button_16 = Button(
            ...
            borderwidth=0,
            highlightthickness=0,
            command=lambda: (self.save_entry_servizi(6)),
            relief="flat"
        )
    ...
    def save_entry_servizi(self, index):
        if index >= len(self.entry_list_servizi) or index < 0:
    ...
    def save_entry_servizi_modifica(self, index):
        if index >= len(self.entry_list_servizi) or index < 0:
            tkinter.messagebox.showerror("Errore", "Prenotazione non trovata")
            return
        ...
        go_modifica_prenotazione_servizi(self.window)
    ...
    def elimina_prenotazione(self):
        ...
        if prenotazione_da_eliminare:
            data[-1]["servizi"].remove(prenotazione_da_eliminare)
